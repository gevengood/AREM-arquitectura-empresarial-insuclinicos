...
## Alcance de esta entrega (Taller 0 — Preliminary y Architecture Vision)

Esta entrega corresponde a las fases **Preliminary** y **Architecture Vision** de TOGAF ADM, base para el resto del trabajo del semestre:

- Ficha de caracterización del cliente.
- Documento de Visión de Arquitectura (mapa conceptual de alto nivel, beneficios esperados, alcance y justificación).
- Registro de trabajo en clase.
- Referencias consultadas.

> Los modelos de Business Architecture AS-IS, Arquitectura de Datos AS-IS y el resto de los entregables del Corte 1 corresponden a los Talleres 1 y 2, y se incorporarán a este repositorio en entregas posteriores.
...
| Documento | Contenido |
|---|---|
| [Ficha de caracterización](docs/01-ficha-caracterizacion.md) | Contexto de la empresa, objetivos estratégicos, problemas, procesos, restricciones y contacto |
| [Visión de arquitectura](docs/02-vision.md) | Mapa conceptual de alto nivel, beneficios esperados trazados a los objetivos estratégicos, alcance (incluyendo el POC de cierre de semestre) y justificación |
| [Notas de clase](docs/03-notas.md) | Registro de trabajo colaborativo, decisiones de modelado y tareas asignadas al equipo |
| [Referencias](docs/04-referencias.md) | Fuentes utilizadas para el levantamiento y desarrollo del análisis |
